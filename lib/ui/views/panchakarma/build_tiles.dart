        ...
        Row(
          ...
          children: [
            BuildRow(mobile,
                ...
                width: width,
                height: height,
                color: Colors.white,//Color(0xffffd5d1),
            ...
            BuildRow(mobile,
                ...
                width: width,
                height: height,
                color: Colors.white,//Color(0xf089CFF0),
        ...
        Row(
          ...
          children: [
            BuildRow(mobile,
                ...
                width: width,
                height: height,
                color: Colors.white,//Color(0xfffde992),
            ...
            BuildRow(mobile,
                ...
                width: width,
                height: height,
                color: Colors.white,//Color(0xffe7accf),
        ...
        Row(
          ...
          children: [
            BuildRow(mobile,
                ...
                width: width,
                height: height,
                color: Colors.white,//Color(0xa0cf352e),
            ...
            BuildRow(mobile,
                ...
                width: width,
                height: height,
                color: Colors.white,//Color.fromRGBO(244, 164, 96, 1),
        ...
        Row(
          ...
          children: [
            BuildRow(mobile,
                ...
                width: width,
                height: height,
                color: Colors.white,//Color(0xfff4C4B2),
            ...
            BuildRow(mobile,
                ...
                width: width,
                height: height,
                color: Colors.white,//Color(0xff50c878),
