...
Widget TreatementMobile({required double width, required double height}) {
  return Material(
      color: Color.fromRGBO(187, 255, 168, 0.5),
      child: Column(children: [
        MobileTop(
            text: 'Diseases',
            description: 'The best treatment on all the following diseases '
                'by Ayurvedic medicine and Panchakarma therapy:',
            width: width,
            height: height),
